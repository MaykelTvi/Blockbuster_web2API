...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-04-2026 a las 04:58:47
...
CREATE TABLE `peliculas` (
  ...
  `id_genero` int(11) NOT NULL,
  `alquilada` tinyint(1) NOT NULL DEFAULT 0,
...
(1, 'Harry Potter y la Piedra Filosofal', 'Chris Columbus', 3, 1, ''),
(2, 'The Shining', 'Stanley Kubrick', 2, 0, ''),
(3, 'Inception', 'Christopher Nolan', 3, 0, ''),
(4, 'Mad Max', 'George Miller', 1, 0, '');
...
(1, 'admin@blockbuster.com', '$2y$10$/YpAqT8vPDIZNnZkx07zR.dpKpMPW.99dIqCiizQdd2q56il6ADkm', 1),
(2, 'cliente@gmail.com', '$2y$10$9boEIiTw.s37isRw8csXP.gNdh9ZahfoQRPn/qJMwsxqrCSZzINy2', 0);
...
ALTER TABLE `alquileres`
  ...
  ADD UNIQUE KEY `id_pelicula_unica` (`id_pelicula`),
...
--
ALTER TABLE `peliculas`
  ADD CONSTRAINT `peliculas_ibfk_1` FOREIGN KEY (`id_genero`) REFERENCES `generos` (`id_genero`) ON DELETE CASCADE;
COMMIT;
